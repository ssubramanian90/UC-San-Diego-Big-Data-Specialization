...
class cm_api():
    ...
    def __init__(self, endpoint=None, method='GET', body='', host='localhost', port=7180, username='admin', password='admin', api_version=10, https=False, asynchronous=True):
        self.host = host
        self.port = port
        self.body = body
        self.https = https
...
def main():
    ...
    parser.add_argument('--https',        action='store_true',                                     help='Use HTTPS for connection to Cloudera Manager')
    parser.add_argument('--asynchronous', action='store_true',                                     help='Return immediately for asynchronous actions')
